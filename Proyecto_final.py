...
from sklearn.model_selection import train_test_split  # Asegúrate de importar esta función
from sklearn.ensemble import RandomForestClassifier
from sklearn.metrics import classification_report, accuracy_score

# Cargar el dataset (asegúrate de que la ruta y el nombre del archivo son correctos)
data = pd.read_csv("C:/Users/manue/Downloads/IA/prfinal/creditcard.csv")

# Separa los datos en X (características) e y (etiquetas)
...
fraud_mean_amount = data[data['Class'] == 1]['Amount'].mean()
print(f"Importe medio de las transacciones fraudulentas: {fraud_mean_amount:.2f}")
...
plt.hist(fraud_data['Amount'], bins=50, color='red')
